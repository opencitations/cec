...
def create_app(src_path):
    app = Flask(__name__, static_url_path='/cic/static', static_folder="static")

    # Configuration of SRC_PATH in the app
    app.config['SRC_PATH'] = src_path

    # Blueprint registration
    app.register_blueprint(interface_bp, url_prefix='/cic/')
    app.register_blueprint(api_bp, url_prefix='/cic/api')
